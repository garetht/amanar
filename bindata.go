...
func amanar_config_schemaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "amanar_config_schema.json", size: 7712, mode: os.FileMode(420), modTime: time.Unix(1536773300, 0)}
